    ...
    <a href="About.html" >About</a>
      <a href="skcheck.html" >SK Checker</a>
        <a href="skgen.html">SK Generator</a>
          <a href="CCGen.html" class="topnavac" style="color: white">CC Generator</a>
...
body {
    font-family: Lato, Helvetica Neue, Helvetica, Arial, Poppins;
    font-size: 15px;
    ...
    "9tPo": function(t, e) {
        t.exports = function(t) {
            ...
            return t.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function(t, e) {
                ...
                return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(o) ? t : (i = 0 === o.indexOf("//") ? o : 0 === o.indexOf("index.html") ? n + o : r + o.replace(/^\.\//, ""), "url(" + JSON.stringify(i) + ")")
            })
        }
    },
    CIWT: function(t, e, n) {
        ...
        var r = n("nc4g"),
            ...
            a = Object(o.a)(i, function() {
                ...
                }, [t._v("Generated Cards:")]), t._v(" "), n("textarea", {
                    directives: [{
                        name: "model",
                        rawName: "v-model",
                        value: t.creditCards,
